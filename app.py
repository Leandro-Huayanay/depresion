...
educacion = st.number_input("Nivel educativo (0 Sin educación, 1 Primaria incompleta, 2 Primaria completa, 3 Secundaria incompleta, 4 Secundaria completa, 5 Superior )", min_value=0, max_value=5)
estado_civil = st.number_input("Estado civil (0 Soltero(a), 1 Casado(a), 2 Conviviente, 3 Viudo(a), 4 Divorciado(a), 5 Separado(a))", min_value=0, max_value=5)
idioma_materno = st.number_input("Idioma materno (0 Español, 1 Quechua, 2 Aimara, 3 Otros)", min_value=0, max_value=5)
...
Es un trabajo de curso de MACHINE LEARNING, no hace diagnostico de depresión
""")
